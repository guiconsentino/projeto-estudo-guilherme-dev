...
public class Console {
	...
	public static void main(String[] args) {
		...
		System.out.printf("%s %s cpf:%s tem %d anos mora na %s", nome, sobrenome, cpf, idade, endereço);
		
		//System.out.println(nome, sobrenome, "cpf:" + cpf, "idade: " + idade, "mora no endereço" + endereço);
